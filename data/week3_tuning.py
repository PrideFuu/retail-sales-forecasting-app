...
print("Best Random Forest:", best_rf_result["metrics"])
print("Best RF params:", best_rf_result["params"])
...
print("Best Gradient Boosting:", best_gb_result["metrics"])
print("Best GB params:", best_gb_result["params"])


# ---------------------------
# Champion Model auswählen
# ---------------------------
